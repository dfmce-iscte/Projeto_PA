...
// value pode ser open??
abstract class LeafJSON(name:String, open val value: Any? = null, final override val parent: CompositeJSON?) : JSONELEMENT {
...
class JSONString(parentObject: CompositeJSON?, override val value : String, name:String="") : LeafJSON(name,value, parentObject)

class JSONNumber(parentObject: CompositeJSON?, override val value : Number,name:String="") : LeafJSON(name,value, parentObject)

class JSONBoolean(parentObject: CompositeJSON?, override val value : Boolean,name: String="") : LeafJSON(name,value, parentObject)
